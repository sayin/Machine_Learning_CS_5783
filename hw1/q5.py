...
x3 = multi_gauss_dist(dim,n_samp) 
x4 = multi_gauss_dist(dim,n_samp) 
x5 = multi_gauss_dist(dim,n_samp) 
x6 = multi_gauss_dist(dim,n_samp) 
x7 = multi_gauss_dist(dim,n_samp) 
x8 = multi_gauss_dist(dim,n_samp) 
x9 = multi_gauss_dist(dim,n_samp) 
x10 = multi_gauss_dist(dim,n_samp) 

x = np.vstack((x1,x2,x3,x4,x5,x6,x7,x8,x9,x10))

y = np.vstack((np.zeros((5*n_samp,1)),np.ones((5*n_samp,1)))) 
